...
<form action="index.php?page=sell" method="post">
    ...
    <?php
				...
				echo "<tr>\n";
				echo "<td style='padding:5px; border:1px solid #000000; text-align:center;'><input type='text' placeholder='Customer Name' name='contactName' value=\"" . $SContactName . "\" oninput='getContactSelect(\"contactSelect\",this.value,$myId)'><br>\n";
