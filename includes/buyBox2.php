...
if ($gIR) {
	...
	$SContactName = getContact ( $SContactId, $db, $myContacts );
...
<form action="index.php?page=buy" method="post">
    ...
    <table style="border: 1px solid #000000;">
        <?php
								echo "<tr>\n";
								echo "<td style='padding:5px; border:1px solid #000000; text-align:center;'><input type='text' name='contactName' value=\"" . $SContactName . "\" onchange='getContactSelect(\"contactSelect\",this.value)'><br>\n";
