            ...
            <?php
												...
												while ( $getLR = $getL->fetch () ) {
													...
													if ($date >= $dateRangeStart && $date <= $dateRangeEnd && $t == 0) {
														...
														echo "<td style='text-align:right;'>" . money ( $accStartBalance, $currency, $langCode ) . "</td>\n";
													...
													if ($date >= $dateRangeStart && $date <= $dateRangeEnd) {
														...
														while ( $getJR = $getJ->fetch () ) {
															...
															echo ($xcreditAmount > 0.00) ? money ( $xcreditAmount, $currency, $langCode ) : "";
															echo "</td>\n";
															echo "<td style='text-align:right;'>";
															echo ($xdebitAmount > 0.00) ? money ( $xdebitAmount, $currency, $langCode ) : "";
															echo "</td>\n";
															echo "<td style='text-align:right;'>" . money ( $accStartBalance, $currency, $langCode ) . "</td>\n";
