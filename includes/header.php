...
if ($myId >= 1) {
	...
	if ($fiscalYear != 0) {
		?>
        <a id="inventoryLink" onclick="toggleviewMenu('inventoryBox')" class="menu">Inventory</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
        <a id="financialLink" onclick="toggleviewMenu('financialBox')" class="menu">Financial</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
        <a id="employeeLink" onclick="toggleviewMenu('employeeBox')" class="menu">Employees</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
        <a id="invoicingLink" onclick="toggleviewMenu('invoicingBox')" class="menu">Invoicing</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
    ...
    <a id="feedbackLink" onclick="toggleviewMenu('feedbackBox')" class="menu">Feedback</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
    <a id="legalLink" onclick="toggleviewMenu('legalBox')" class="menu">Legal</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
    ...
    <div style="text-align:center; font-weight:bold;">
    <a id="legalLink" onclick="toggleviewMenu('legalBox')" class="menu">Legal</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
        <a id="signInLink" onclick="toggleviewMenu('signInBox')" class="menu">Sign&nbsp;in&nbsp;/&nbsp;Register</a>
    </div>
    <?php
}
if ($loginErr != "x") {
...
<?php
	if ($myId >= 1) {
		?>
        <div id='feedbackBox' style='display:none; border:1px solid black; text-align:center; background-color: #ffffff; color: #000000; width:97%; padding:20px; margin-top:20px;'>
	        <form method='post' action='index.php'>
		        <span class="heading" style="font-size:1.25em;">Any questions, comments, or feedback?</span><br /><br>
        ...
        <div id='inventoryBox' style='display:none; border:1px solid black; text-align:center; background-color: #ffffff; color: #000000; width:97%; padding:20px; font-weight:bold; margin-top:20px;'>
	        <a href="index.php?page=inventory" class="menu">Inventory</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
	        <a href="index.php?page=recipes" class="menu">Recipes</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
	        <a href="printInv.php" class="menu">Print Inventory</a>
        </div>

        <div id='invoicingBox' style='display:none; border:1px solid black; text-align:center; background-color: #ffffff; color: #000000; width:97%; padding:20px; font-weight:bold; margin-top:20px;'>
	        ...
	        <a href="index.php?page=settings&r=salesPurchasing" class="menu">Sales Purchasing Settings</a>
        </div>

        <div id='financialBox' style='display:none; border:1px solid black; text-align:center; background-color: #ffffff; color: #000000; width:97%; padding:20px; font-weight:bold; margin-top:20px;'>
	        <a href="index.php?page=journals" class="menu">Bank Registers</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
	        <a href="index.php?page=reports&r=sales" class="menu">End of day Report</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
	        ...
	        <a href="index.php?page=settings&r=company" class="menu">Company Settings</a>
        </div>

        <div id='employeeBox' style='display:none; border:1px solid black; text-align:center; background-color: #ffffff; color: #000000; width:97%; padding:20px; font-weight:bold; margin-top:20px;'>
	        <a href="index.php?page=settings&r=salesAssociate" class="menu">Employees</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
	        <a href="index.php?page=settings&r=payroll" class="menu">Payroll</a>&nbsp;&nbsp;<span class="mcat">|</span>&nbsp;&nbsp;
        	<a href="index.php?page=settings&r=milage" class="menu">Milage</a>
        </div>

        <div id='legalBox' style='display:none; border:1px solid black; text-align:center; background-color: #ffffff; color: #000000; width:97%; padding:20px; margin-top:20px;'>
		    <span style="font-size:1em;"><?php
		echo $legalText;
		?></span>
	    </div>

		<div style="text-align:center; font-weight:bold; margin-top:20px;"><a id="quickEntryLink" onclick="toggleviewMenu('quickEntryBox')" class="menu">Quick Entry</a></div>
		...
		if ($useMilage == 1) {
			...
			echo $myId;
			?>)"><?php
			$v = $db->prepare("SELECT id,name FROM $myVehicles WHERE retired = '0' ORDER BY name");
			$v->execute();
			while ($vr = $v->fetch()) {
				echo "<option value='" . $vr['id'] . "'>" . $vr['name'] . "</option>\n";
			}
			?></select></td>
		...
		<td style='text-align:left; padding-left:10px;'><input type='text' name='qContactName' value='' placeholder='contact' oninput='getContactSelect("contactSelect", this.value, <?php
		echo $myId;
		?>)'>
            <br />
