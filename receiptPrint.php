    ...
    <div id="printArea">
        <?php
								if (filter_input ( INPUT_POST, 'printId', FILTER_SANITIZE_NUMBER_INT )) {
									...
									echo "<td style='padding:5px; border:1px solid #000000; text-align:center;'>" . money ( ($transDiscount / 100) * $total, $currency, $langCode ) . "</td>\n";
									echo "</tr>\n";
									echo "<tr>\n";
									echo "<td colspan='2'></td>\n";
									...
									echo "<td style='padding:5px; border:1px solid #000000; text-align:center;'>" . money ( $gTotal, $currency, $langCode ) . "</td>\n";
									echo "</tr>\n";
