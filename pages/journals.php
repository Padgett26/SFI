...
if ($myId >= 1) {
	...
	$an = (filter_input(INPUT_GET, 'an', FILTER_SANITIZE_NUMBER_INT)) ? filter_input(INPUT_GET, 'an', FILTER_SANITIZE_NUMBER_INT) : '0'; // grab
	                                                                                                                                     // account
	$je = (filter_input(INPUT_GET, 'je', FILTER_SANITIZE_NUMBER_INT)) ? filter_input(INPUT_GET, 'je', FILTER_SANITIZE_NUMBER_INT) : '0'; // grab
	                                                                                                                                     // journal
	                                                                                                                                     // entry
	$type = (filter_input(INPUT_GET, 'type', FILTER_SANITIZE_NUMBER_INT)) ? filter_input(INPUT_GET, 'type', FILTER_SANITIZE_NUMBER_INT) : '0'; // grab
	                                                                                                                                           // typeCode
