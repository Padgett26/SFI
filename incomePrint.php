...
$dateRangeStart = filter_input(INPUT_POST, 'dateRangeStart',
        FILTER_SANITIZE_NUMBER_INT);
$dateRangeEnd = filter_input(INPUT_POST, 'dateRangeEnd',
        FILTER_SANITIZE_NUMBER_INT);
?>
<div id="printArea">
<table>
...
<?php
echo $companyName . "<br />" . $companyAddress1 . "<br />" . $companyAddress2 .
        "<br />" . $companyPhone . "<br />" . $companyEmail;
?>
</div>
</td>
</tr>
